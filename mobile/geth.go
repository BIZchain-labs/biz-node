...
// NodeConfig represents the collection of configuration values to fine tune the Biz
...
// Node represents a Biz Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Biz node.
