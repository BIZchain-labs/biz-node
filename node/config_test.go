...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "biz.ipc", false, filepath.Join(os.TempDir(), "biz.ipc")},
		{"data", "biz.ipc", false, "data/biz.ipc"},
		{"data", "./biz.ipc", false, "./biz.ipc"},
		{"data", "/biz.ipc", false, "/biz.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "biz.ipc", true, `\\.\pipe\biz.ipc`},
		{"data", "biz.ipc", true, `\\.\pipe\biz.ipc`},
		{"data", `\\.\pipe\biz.ipc`, true, `\\.\pipe\biz.ipc`},
	}
