...
import (
	...
	"github.com/BIZchain-labs/biz-node/consensus/congress"
	"github.com/BIZchain-labs/biz-node/core"
	"github.com/BIZchain-labs/biz-node/core/bloombits"
	"github.com/BIZchain-labs/biz-node/core/rawdb"
	"github.com/BIZchain-labs/biz-node/core/state/pruner"
	...
	"github.com/BIZchain-labs/biz-node/eth/filters"
	"github.com/BIZchain-labs/biz-node/eth/gasprice"
	"github.com/BIZchain-labs/biz-node/eth/protocols/eth"
	"github.com/BIZchain-labs/biz-node/eth/protocols/snap"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, Biz %s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
